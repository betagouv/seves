...
class Migration(migrations.Migration):
    dependencies = [
        ("core", "0033_export"),
        ("ssa", "0024_evenementproduit_pam_requires_danger_bacterien"),
    ]
