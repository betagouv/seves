...
def change_values(apps, schema_editor):
    EvenementProduit = apps.get_model("ssa", "EvenementProduit")
    EvenementProduit.objects.filter(categorie_produit="Subtitut de produit carné").update(
        categorie_produit="Substitut de produit carné"
    )
    EvenementProduit.objects.filter(categorie_produit="Subtitut de produit aquatique").update(
        categorie_produit="Substitut de produit aquatique"
    )
    EvenementProduit.objects.filter(
        categorie_produit="GC - Préparation à base de céréale et d'eau (pâte, nouille ou vermiGClle, sans œuf)"
    ).update(categorie_produit="GC - Préparation à base de céréale et d'eau (pâte, nouille ou vermicelle, sans œuf)")


def reverse_change_values(apps, schema_editor):
    EvenementProduit = apps.get_model("ssa", "EvenementProduit")
    EvenementProduit.objects.filter(categorie_produit="Substitut de produit carné").update(
        categorie_produit="Subtitut de produit carné"
    )
    EvenementProduit.objects.filter(categorie_produit="Substitut de produit aquatique").update(
        categorie_produit="Subtitut de produit aquatique"
    )
    EvenementProduit.objects.filter(
        categorie_produit="GC - Préparation à base de céréale et d'eau (pâte, nouille ou vermicelle, sans œuf)"
    ).update(categorie_produit="GC - Préparation à base de céréale et d'eau (pâte, nouille ou vermiGClle, sans œuf)")


class Migration(migrations.Migration):
    dependencies = [
        ("ssa", "0067_evenementproduit_maestro_reference"),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                ...
                choices=[
                    ...
                    (
                        "Produit aquatique indéterminé",
                        "Produit aquatique > Produit aquatique indéterminé",
                    ),
                    ...
                    (
                        "Substitut de produit carné",
                        "Analogue végétal > Substitut de produit carné",
                    ),
                    (
                    ...
                    (
                        "Environnement",
                        "Environnement > Environnement de production - surface",
                    ),
        ...
        migrations.RunPython(change_values, reverse_change_values),
    ]
