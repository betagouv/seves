...
def test_can_add_and_see_note_in_new_tab_with_specific_date(live_server, page: Page):
    evenement_produit = EvenementProduitFactory(etat=EvenementProduit.Etat.EN_COURS)
    generic_test_can_add_and_see_note_in_new_tab_with_specific_date(live_server, page, evenement_produit)
...
def test_can_search_in_message_list(live_server, page: Page):
    evenement_produit = EvenementProduitFactory(etat=EvenementProduit.Etat.EN_COURS)
    generic_test_can_search_in_message_list(live_server, page, evenement_produit)


def test_cant_see_messages_in_internal_state(live_server, page: Page, mocked_authentification_user):
    evenement_produit = EvenementProduitFactory(etat=EvenementProduit.Etat.EN_COURS)
    generic_test_cant_see_messages_in_internal_state(live_server, page, mocked_authentification_user, evenement_produit)
