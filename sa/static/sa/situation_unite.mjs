...
/**
 * @property {HTMLSelectElement} especeSelectTarget
...
class SituationUniteController extends BaseFormInModal {
    ...
    refreshSelectionCascade({keepSelection}) {
        ...
        const especeId = this.especeSelectTarget.value
    ...
    hasCompleteSituation() {
        ...
        return isValidPath(getSharedTree(), this.especeSelectTarget.value, [
            s.typeLieu,
            s.modeElevage,
            s.typeProduction,
            s.typeElevage,
