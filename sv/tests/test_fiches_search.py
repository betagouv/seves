...
def test_search_with_fiche_number(live_server, page: Page, mocked_authentification_user) -> None:
    ...
    FicheDetectionFactory(evenement__numero_annee=2024, evenement__numero_evenement=1, numero_detection=1)
    FicheDetectionFactory(evenement__numero_annee=2024, evenement__numero_evenement=2, numero_detection=1)
...
def test_list_is_ordered(live_server, page):
    FicheDetectionFactory(evenement__numero_annee=2024, evenement__numero_evenement=1, numero_detection=30)
    FicheDetectionFactory(evenement__numero_annee=2023, evenement__numero_evenement=1, numero_detection=7)
    FicheDetectionFactory(evenement__numero_annee=2024, evenement__numero_evenement=2, numero_detection=31)
