...
def test_evenement_numero_fiche_is_null_when_save_with_visibilite_brouillon(
    ...
    fiche_detection = FicheDetection.objects.get()
    assert fiche_detection.evenement.numero is None
    assert fiche_detection.evenement.visibilite == Visibilite.BROUILLON
