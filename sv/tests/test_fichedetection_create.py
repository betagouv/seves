...
def _add_localisation_form_fields_are_empty(page: Page, lieu_form_elements: LieuFormDomElements):
...
def _check_select_options(page, label, expected_options):
...
def test_new_fiche_detection_form_content(live_server, page: Page, form_elements: FicheDetectionFormDomElements):
    ...
    _check_select_options(page, "Créateur", unites)
    ...
    _check_select_options(page, "Statut évènement", statuts_evenement)
    ...
    _check_select_options(page, "Statut règlementaire", statuts_reglementaire)
    ...
    _check_select_options(page, "Contexte", contextes)
...
def test_add_localisation_form_have_all_fields(
    ...
    _check_select_options(page, "Département", departements)
...
def test_add_lieu_form_is_empty_after_close_edit_form_with_close_btn_without_save(
    ...
    _add_localisation_form_fields_are_empty(page, lieu_form_elements)
