...
def test_contacts_agents_order_in_list(live_server, page, fiche_detection):
    ...
    fiche_detection.contacts.set([contact1, contact2])
...
@pytest.mark.django_db
def test_contacts_structures_order_in_list(live_server, page, fiche_detection):
