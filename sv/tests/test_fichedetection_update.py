...
from ..models import (
    ...
    OrganismeNuisible, LaboratoireAgree, LaboratoireConfirmationOfficielle,
)
from ..models import (
    Region,
)
...
def test_can_pick_inactive_labo_confirmation_in_prelevement_is_old_fiche(
    ...
    assert prelevement_form_elements.laboratoire_confirmation_label.locator(f'option[value="{labo.pk}"]').count() == 1
