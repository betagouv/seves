...
class FicheZoneDelimiteeFormPage:
    ...
    def __init__(self, page: Page, choice_js_fill):
        ...
        self.rayon_zone_tampon_unite_m = page.get_by_text("m", exact=True)
        self.rayon_zone_tampon_unite_km = page.get_by_text("km", exact=True)
        ...
        # Zones infestées
        self.zone_infestee_numero_base_locator = "#id_zoneinfestee_set-{}-numero"
    ...
    def _fill_zone_infestee_form(
        ...
        self.page.locator(self.zone_infestee_numero_base_locator.format(index)).fill(zoneinfestee.numero)
