...
class Lieu(models.Model):
	...
	fiche_detection = models.ForeignKey('FicheDetection', on_delete=models.CASCADE, verbose_name="Fiche de détection", related_name="lieux")
	...
	departement = models.ForeignKey(Departement, on_delete=models.PROTECT, verbose_name="Département", blank=True, null=True)
...
class Etablissement(models.Model):
	...
	statut = models.ForeignKey(StatutEtablissement, on_delete=models.PROTECT, verbose_name="Statut", blank=True, null=True)
	nom = models.CharField(max_length=100, verbose_name="Nom", blank=True)
	...
	type_exploitant = models.ForeignKey(TypeExploitant, on_delete=models.PROTECT, verbose_name="Type d'exploitant", blank=True, null=True)
	position_chaine_distribution = models.ForeignKey(PositionChaineDistribution, on_delete=models.PROTECT, verbose_name="Position dans la chaîne de distribution", blank=True, null=True)
...
class PrelevementNonOfficiel(models.Model):
	...
	site_inspection = models.ForeignKey(SiteInspection, on_delete=models.PROTECT, verbose_name="Site d'inspection", blank=True, null=True)
	matrice_prelevee = models.ForeignKey(MatricePrelevee, on_delete=models.PROTECT, verbose_name="Matrice prélevée", blank=True, null=True)
	espece_echantillon = models.ForeignKey(EspeceEchantillon, on_delete=models.PROTECT, verbose_name="Espèce de l'échantillon", blank=True, null=True)
...
class PrelevementOfficiel(models.Model):
	...
	laboratoire_agree = models.ForeignKey(LaboratoireAgree, on_delete=models.PROTECT, verbose_name="Laboratoire agréé", blank=True, null=True)
	laboratoire_confirmation_officielle = models.ForeignKey(LaboratoireConfirmationOfficielle, on_delete=models.PROTECT, verbose_name="Laboratoire de confirmation officielle", blank=True, null=True)
...
class FicheDetection(models.Model):
	...
	statut_evenement = models.ForeignKey(StatutEvenement, on_delete=models.PROTECT, verbose_name="Statut de l'événement", blank=True, null=True)
	
	# Objet de l'événement
	organisme_nuisible = models.ForeignKey(OrganismeNuisible, on_delete=models.PROTECT, verbose_name="OEPP", blank=True, null=True)
	statut_reglementaire = models.ForeignKey(StatutReglementaire, on_delete=models.PROTECT, verbose_name="Statut règlementaire de l'organisme", blank=True, null=True)
	contexte = models.ForeignKey(Contexte, on_delete=models.PROTECT, verbose_name="Contexte", blank=True, null=True)
