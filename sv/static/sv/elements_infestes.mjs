...
class ElementInfesteFormController extends BaseFormInModal {
    ...
    clean(formValues) {
        if (formValues.quantite_unite !== "" && formValues.quantite === "") {
            const checked = this.quantiteUniteInputTargets.filter(it => it.checked)[0]
            this.quantiteInputTarget.setCustomValidity(
                `L'option « ${checked.labels[0].innerText} » est cochée. Veuillez renseigner une valeur ici.`,
            )
