...
SECURE_CSP = {
    ...
    "script-src": (
        ...
        "https://cdn.jsdelivr.net/npm/eventemitter3@5.0.1/+esm",
...
SEND_NOTIFICATIONS = env("SEND_NOTIFICATIONS", default=True)
SEND_PERMISSION_NOTIFICATION = env("SEND_PERMISSION_NOTIFICATION", default=True)
