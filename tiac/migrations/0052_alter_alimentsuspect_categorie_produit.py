...
def change_values(apps, schema_editor):
    AlimentSuspect = apps.get_model("tiac", "AlimentSuspect")
    AlimentSuspect.objects.filter(categorie_produit="Subtitut de produit carné").update(
        categorie_produit="Substitut de produit carné"
    )
    AlimentSuspect.objects.filter(categorie_produit="Subtitut de produit aquatique").update(
        categorie_produit="Substitut de produit aquatique"
    )
    AlimentSuspect.objects.filter(
...
def reverse_change_values(apps, schema_editor):
    AlimentSuspect = apps.get_model("tiac", "AlimentSuspect")
    AlimentSuspect.objects.filter(categorie_produit="Substitut de produit carné").update(
        categorie_produit="Subtitut de produit carné"
    )
    AlimentSuspect.objects.filter(categorie_produit="Substitut de produit aquatique").update(
...
class Migration(migrations.Migration):
    dependencies = [
        ("tiac", "0051_alter_investigationtiac_nb_sick_persons"),
    ]
