...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunSQL(
            """UPDATE tiac_investigationtiac SET selected_hazard = '{' || selected_hazard || '}';""",
            reverse_sql="""UPDATE tiac_investigationtiac SET selected_hazard = regexp_replace(regexp_replace(selected_hazard, '^{"?', '', 'x'), '"?}$', '', 'x');""",
        ),
