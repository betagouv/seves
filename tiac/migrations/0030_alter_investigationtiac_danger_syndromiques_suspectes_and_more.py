            ...
            field=django.contrib.postgres.fields.ArrayField(
                base_field=models.CharField(
                    choices=[
                        ...
                        (
                            "gastro-enterite",
                            "Virus de la Gastro-entérite aigüe virale à norovirus, <span class='danger-emphasis'>sapovirus</span> etc. <div class=\"fr-hint-text\">Incubation longue (10h - 50h) - tous symptômes de gastro-entérite, vomissements très fréquents, fièvre ~50% des cas - cas secondaires fréquents (transmission inter-humaine)</div>",
                        ),
                        (
                        ...
                        (
                            "autre",
                            'Autres cas <div class="fr-hint-text">Préciser les symptômes et les investigations médicales dans le contenu du signalement et dans le fil de suivi.</div>',
                        ),
                    ],
                    max_length=255,
                ),
            ...
            field=django.contrib.postgres.fields.ArrayField(
                base_field=models.CharField(
                    choices=[
                        ...
                        (
                            "toxi infection bacillus cereus",
                            "Bacillus Cereus - Clostridium Perfringen",
                        ),
                        ("bactérie intestinale", "Infection bactérienne intestinale"),
                        (
                            "shu",
                            "STEC avec cas de syndrome hémolytique et urémique (SHU)",
                        ),
                        ...
                        (
                            "toxine des poissons",
                            "Intoxination par des poissons coralliens",
                        ),
                        ("autre", "Autres cas"),
                        (
                            "Allergène - Arachide",
