# Generated by Django 5.2.7 on 2025-10-10 07:12

import django.contrib.postgres.fields
from django.db import migrations, models


def empty_existing_values(apps, schema_editor):
    AnalyseAlimentaire = apps.get_model("tiac", "AnalyseAlimentaire")
    AnalyseAlimentaire.objects.update(categorie_danger="{}")


class Migration(migrations.Migration):
    dependencies = [
        ("tiac", "0019_analysealimentaire"),
    ]

    operations = [
        migrations.RunPython(empty_existing_values, migrations.RunPython.noop),
