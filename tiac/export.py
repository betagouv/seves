...
class TiacExport(BaseExport):
    ...
    evenement_fields = [
        ...
        ("date_reception", "Date de réception à la DD(ETS)PP"),
        ...
        ("follow_up", "Suite donnée par la DD"),
        ...
        ("danger_syndromiques_suspectes", "Danger syndromique"),
        ("analyses_sur_les_malades", "Analyses engagées sur les malades"),
        ("precisions", "Précisions"),
        ("agents_confirmes_ars", "Agent pathogènes"),
