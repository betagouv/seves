...
class Document(models.Model):
    class TypeDocument(models.TextChoices):
        ...
        CARTOGRAPHIE = "cartographie", "Cartographie / plans / localisation"
        ...
        COURRIER_OFFICIEL = "courrier_officiel", "Correspondances (courriers, e-mails)"
        DSCE = "dsce", "DSCE"
        FACTURE = "facture", "Facture"
        IMAGE = "image", "Image/photo"
        NOTE_TECHNIQUE = "note_technique", "Note technique / Avis / Documentation interne"
        NOTIFICATION_UE = "notification_ue", "Notification UE (Europhyt, iRASFF)"
        ...
        TRACABILITE = "tracabilité", "Traçabilité / mouvements / livraisons"
