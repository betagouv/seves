...
document.addEventListener('DOMContentLoaded', () => {
    ...
    documentTypeSelect.addEventListener('change', () => onDocumentTypeChange(fileInput, documentTypeSelect, extensionsInfoSpan));
...
function onDocumentTypeChange(fileInput, documentTypeSelect, extensionsInfoSpan) {
    const documentTypeAllowedExtensions = getAcceptAllowedExtensionsAttributeValue(fileInput, documentTypeSelect);
